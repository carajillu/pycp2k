...
class _nonbonded2(InputSection):
    def __init__(self):
        ...
        self._repeated_subsections = {'LENNARD_JONES': '_lennard_jones1', 'WILLIAMS': '_williams1', 'EAM': '_eam1', 'QUIP': '_quip1', 'GOODWIN': '_goodwin1', 'IPBV': '_ipbv1', 'BMHFT': '_bmhft1', 'BMHFTD': '_bmhftd1', 'BUCK4RANGES': '_buck4ranges1', 'BUCKMORSE': '_buckmorse1', 'GENPOT': '_genpot2', 'TERSOFF': '_tersoff1', 'SIEPMANN': '_siepmann1', 'GAL19': '_gal191', 'GAL21': '_gal211'}
        self._attributes = ['LENNARD_JONES_list', 'WILLIAMS_list', 'EAM_list', 'QUIP_list', 'GOODWIN_list', 'IPBV_list', 'BMHFT_list', 'BMHFTD_list', 'BUCK4RANGES_list', 'BUCKMORSE_list', 'GENPOT_list', 'TERSOFF_list', 'SIEPMANN_list', 'GAL19_list', 'GAL21_list']
